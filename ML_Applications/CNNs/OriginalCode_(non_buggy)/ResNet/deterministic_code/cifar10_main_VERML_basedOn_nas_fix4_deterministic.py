...
parser.add_argument('--data_dir', type=str, default='cifar10_data_small',
...
def main(unused_argv):
  ...
  run_config = tf.estimator.RunConfig().replace(tf_random_seed=_SEED, save_checkpoints_secs=1e9)
